; ModuleID = 'test_m.c'
source_filename = "test_m.c"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128"
target triple = "arm64-apple-macosx11.0.0"

@.str = private unnamed_addr constant [32 x i8] c"Bitte geben Sie eine Zahl ein?\0A\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable
define i32 @add4(i32 %0) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define i32 @doMore(i32 %0, i32 %1, i32 %2, i32 %3) #0 {
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %2, align 4
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str, i64 0, i64 0))
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %2)
  store i32 0, i32* %3, align 4
  %6 = load i32, i32* %2, align 4
  %7 = call i32 @add4(i32 %6)
  store i32 %7, i32* %3, align 4
  %8 = load i32, i32* %3, align 4
  %9 = call i32 @add4_(i32 %8)
  ...
  %17 = call i32 @doMore(i32 %10, i32 %12, i32 %14, i32 %16)
